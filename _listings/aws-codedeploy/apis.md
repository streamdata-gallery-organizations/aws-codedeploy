...
- name: AWS CodeDeploy API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/aws-codedeploy/master/_listings/aws-codedeploy/action-updatedeploymentgroup-get.md
x-common:
